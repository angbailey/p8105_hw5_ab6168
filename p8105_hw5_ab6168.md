...
Make plot showing the average estimate of mu on the y axis and the true
...
Make a second plot (or overlay on the first) showing the average
estimate of mu only in samples for which the null was rejected on the
y-axis and the true value of mu on the x-axis. Is the sample average of
mu across tests for which the null is rejected approximately equal to
