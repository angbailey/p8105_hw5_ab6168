...
There are `r nrow(homicide_data)`observations with 12 variables. The data includes the location of the killing, whether an arrest was made, and basic demographic information about each victim. 
